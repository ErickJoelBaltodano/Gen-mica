...
Repositorio para almacenar las prácticas realizadas durante el curso Genómica Computacional 2026-1.
<table>
    <tr>
        <th>  Títular </th>
        <th> Nombre </th>
    ...
    <tr>
        <td>👨🏼‍🏫 PROFESOR: </td>
        <td>Sergio Hernández López</td>
    </tr>
    <tr>
        <td>👩🏻 AYUDANTE LAB: </td>
        <td>Jazmín de Jesús Santillán Manjarrez</td>
    </tr>
    <tr>
        <td>👦🏻 AYUDANTE TEORÍA: </td>
        <td>Rafael López Martínez</td>
    </tr>
...
<table>
    ...
    <tr>
        <th>Baltodano Cuevas Erick Joel</th>
        <th>312245924</th>
    </tr>
    <tr>
    ...
    <tr>
        <td>Rueda Tokuhara Daiki Benedek</td>
        <td>4200003533</td>
    </tr>
</table>
